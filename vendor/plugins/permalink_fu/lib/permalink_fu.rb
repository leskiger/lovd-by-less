...
module PermalinkFu
  ...
  module PluginMethods
    ...
    def has_permalink(attr_names = [], permalink_field = nil, options = {})
      ...
      ClassMethods.setup_permalink_fu_on self do
        ...
        self.permalink_options    = {:unique => true, :create_on_update => false}.update(options)
      end
    end
  end
  ...
  protected
    def create_common_permalink
      ...
      if read_attribute(self.class.permalink_field).to_s.empty? || self.class.permalink_options[:create_on_update]
    ...
    def create_unique_permalink
      logger.info "**** create_unique_permalink should_create_permalink? #{should_create_permalink?}"
